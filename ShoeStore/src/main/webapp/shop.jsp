...
<head>
	...
	<!--
            CSS
            ============================================= -->
	<link rel="stylesheet" href="views/web/template/css/linearicons.css" type="text/css" >
	<link rel="stylesheet" href="views/web/template/css/owl.carousel.css" type="text/css" >
	<link rel="stylesheet" href="views/web/template/css/font-awesome.min.css" type="text/css" >
	<link rel="stylesheet" href="views/web/template/css/themify-icons.css" type="text/css" >
	<link rel="stylesheet" href="views/web/template/css/nice-select.css" type="text/css" >
	<link rel="stylesheet" href="views/web/template/css/nouislider.min.css" type="text/css" >
	<link rel="stylesheet" href="views/web/template/css/bootstrap.css" type="text/css" > 
	<link rel="stylesheet" href="views/web/template/css/main.css" type="text/css" >
...
<body id="category">
	...
	<header class="header_area sticky-header">
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="#"><img src="views/web/template/img/logo.png" alt=""></a>
		...
		<div class="search_input" id="search_input_box">
			<div class="container">
				<form action="SearchProductServlet" method="post" class="d-flex justify-content-between">
			...
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-categories">
					...
					<div class="common-filter">
						...
						%>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="apple" name="brand"><label for="apple"> <a class="" href="SearchProductServlet?cid=<%= CategoryList.get(i).getId() %>"><%= CategoryList.get(i).getName() %></a></label></li>
					<% } %>
							</ul>
						</form>
					</div>
					<div class="common-filter">
						...
						%>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="black" name="color"><label for="black"><a class="" href="SearchProductServlet?cid1=<%= size %>"><%= size %></a></label></li>
									<% } %>
							</ul>
						</form>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="<%= ProductList.get(i).getImage() %>" alt="">
